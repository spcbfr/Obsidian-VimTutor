...
(function (global, factory) {
    ...
    function set(config) {
        ...
        // TODO:960 Remove "ordinalParse" fallback in next major release.
    ...
    function setMonth(mom, value) {
        ...
        if (typeof value === 'string') {
            if (/^\d+$/.test(value)) {
                ...
                // TODO:190 Another silent failure?
                if (!isNumber(value)) {
                    return mom;
                }
            }
    ...
    function loadLocale(name) {
        var oldLocale = null,
            aliasedRequire;
        // TODO:390 Find a better way to register and load all the locales in Node
        if (
    ...
    function checkWeekday(weekdayStr, parsedInput, config) {
        if (weekdayStr) {
            // TODO:1060 Replace the vanilla JS Date object with an independent day-of-week check.
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // TODO:1480 We need to take the current isoWeekYear, but that depends on
    ...
    function configFromStringAndFormat(config) {
        // TODO:780 Move this to another part of the creation flow to prevent circular deps
    ...
    // TODO:2990 remove 'name' arg after deprecation is removed
    ...
    addRegexToken('Do', function (isStrict, locale) {
        // TODO:970 Remove "ordinalParse" fallback in next major release.
        return isStrict
